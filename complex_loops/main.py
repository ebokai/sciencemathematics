...
orders = np.random.randint(1, 4, n_parts)
coeffs = [np.random.uniform(-1, 1, order + 1) for order in orders]
powers = [np.arange(order + 1) for order in orders]

# Function parameters
k1 = np.random.randint(-10, 10, n_parts)
k2 = np.random.randint(-10, 10, n_parts)
dt = np.random.randint(750, 7500, n_parts)
...
r = np.random.uniform(0.1, 0.3, (n_z, 2))
d4 = np.random.randint(750, 7500, n_z)

ro = np.random.uniform(0.1, 0.3, (n_z, 2))
d5 = np.random.randint(750, 7500, n_z)

pa = np.pi / 6 * np.random.randint(0, 2, (n_z, 2))
d6 = np.random.randint(750, 7500, n_z)

pb = np.pi / 6 * np.random.randint(0, 2, (n_z, 2))
